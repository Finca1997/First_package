...
<!--/#header-->
<section id="body">
    <form method="post" action="#" onClick="ch();">
    
    <div class="editor">
    <br>
      <span style="width:150px; display:inline-block; text-align:center; line-height:30px;">标题:</span><input type="text" style="width:800px;;" placeholder="" name="title" />
      
      <script id="editor" type="text/plain" style="width:1000px;height:400px; clear:both;"></script>
      <textarea name="content" id="wenben" style="display:none;"></textarea>
      <input type="submit" name="sub" id="sure" style=" display:inline-block; width:100px; text-align:center; margin-left:45%;">
    </div>
    </form>
</section>
...
<script type="text/javascript">
	...
	function ch(){
		document.getElementById("wenben").innerHTML=UE.getEditor('editor').getPlainTxt();
		}
</script>
</body>
</html>
